...
* C# / PHP / Java / Rubyでのサーバーサイド開発・設計・運用経験
* AWSのクラウドサービス利用・運用経験
...
<table>
  <tbody>
    ...
    <tr>
      <td>概要</td>
      <td>不動産ポータルサイト「LIFULL HOME'S」の開発・運用</td>
    </tr>
    <tr>
      <td>規模</td>
      <td>
        平均4人〜5人でのチーム開発(企画 + エンジニア + デザイナー)<br>
        ※アサインされるPJによる
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>PHP(Symfony)、Ruby(Sinatra)で開発された「LIFULL HOME'S」の新機能開発、保守/運用を担当。
        <details>
          <summary>詳細</summary>
          フロントからサーバサイドまで幅広く、企画の方々と密にコミュニケーションを取りながら開発に携わっています。主に担当した機能は、月々支払額のローンシミュレータ、価格相場、マンション管理評価などがあります。どの施策においても他部署との調整や企画、デザイナー、プロダクトオーナーと多くの人と連携しながら開発を進めていく必要があり、建設的なコミュニケーションを心掛けて開発に従事してきました。また、縮退したサービスに使用されていたコードのリファクタリング、SEOやCore Web Vitalsの改善、サイト訪問者の行動分析ツールのKARTEやTealiumなどといったツールの活用など幅広い業務に従事してきました。<br><br>
          クライアントからは以下の評価を頂いております。<br>
          ----- <br>
          若いメンバーの多いチームの中で貴重な戦力として活躍頂いており、
          現在は特に大きめの案件について開発を進めていただいています。
          日常的なコミュニケーションも温和で企画のメンバーからの信頼も厚く
          私からも安心して仕事をお渡しすることができています。<br>
          ----- <br>
          外部からの突発的な問合せにも堅実に対応してくださるので
          企画を含む他のメンバーが安心して
          開発に取り組める要因にもなっていると思います<br>
          ----- <br>
          ユーザへの価値提供だけではなく、不要コードの削除やバグ対応など
          BPRの面も含めてマルチに対応していただいています。
          手が空いた際も声がけや自主的なタスク探しに動いて頂いており
          私だけではなく他のエンジニアや他職種からも連携がしやすいです。<br>
          ----- <br>
       </details>
      </td>
    </tr>
...
<table>
  <tbody>
    ...
    <tr>
      <td>概要</td>
      <td>
        キャリア形成プラットフォーム「Graspy」の開発・運用<br>
        新卒学生 逆求人型キャリア支援サービス「intee」の開発・運用
      </td>
    </tr>
    <tr>
      <td>規模</td>
      <td>平均2人〜3人でのアジャイルまたは、スクラム開発</td>
    </tr>
    <tr>
      <td>役割</td>
    ...
    <tr>
      ...
      <td>フロントエンドは Nuxt.js(Vue.js)、 サーバサイドは Laravel を用いて転職サイトの新規立ち上げからリリース、保守/運用を担当。
        <details>
          <summary>詳細</summary>
          サーバーサイドはAPIの設計/実装、フロントはAtomic Designを用いたコンポーネント設計/実装まで多岐に渡り開発に従事しました。新規事業ということもあり、如何に早く作りリリースすることができるかを心掛けました。ビジネスサイドとも密にコミュニケーションを取り、優先順位をどうするか何度も協議を重ねたり、一部開発チームメンバーのディレクションを行なったりと幅広い業務に従事してきました。スピードを重視した結果、LaravelのControllerを肥大化してしまった負債を作ってしまい、リリース後はMVCからADR(Action Domain Responder)にリファクタリングの対応も行いました。
        </details>
      </td>
    </tr>
  </tbody>
...
<table>
  <tbody>
    ...
    <tr>
      <td>概要</td>
      <td>
        競馬のポータルサイト「競馬のカリスマ」の開発・運用<br>
        学務パッケージシステムの開発・運用
      </td>
    </tr>
    <tr>
      <td>規模</td>
      <td>平均5人〜6人でのチーム開発<br>※PJによる</td>
    </tr>
    <tr>
      <td>役割</td>
...
<table>
  <tbody>
    ...
    <tr>
      <td>概要</td>
      <td>某銀行の次期勘定系(外国為替保証取引)システムの開発</td>
    </tr>
    <tr>
      <td>規模</td>
      <td>80名程度</td>
...
<table>
  <tbody>
    ...
    <tr>
      <td>概要</td>
      <td>エステサロン通い放題サブスクリプションサービス「Salt.」の開発・運用</td>
    </tr>
    <tr>
      <td>規模</td>
      <td>アプリ2人・サーバーサイド3人でのアジャイル開発</td>
    </tr>
    <tr>
      <td>役割</td>
      <td>要件定義 / マネジメント / 進捗管理 / 設計 / コーディング(サーバーサイド) / コードレビュー / 本番リリース作業</td>
    </tr>
    <tr>
      <td>詳細</td>
...
<table>
  <tbody>
    ...
    <tr>
      <td>概要</td>
      <td>インテリアコーディネートサービス「Amour(アムール)」の開発</td>
    </tr>
    <tr>
      <td>規模</td>
      <td>フロント2人・サーバーサイド2人でのアジャイル開発</td>
    </tr>
    <tr>
      <td>役割</td>
      <td>コーディング(フロントエンド) / コードレビュー</td>
    </tr>
    <tr>
      <td>詳細</td>
...
<table>
  <tbody>
    ...
    <tr>
      <td>概要</td>
      <td>美容整形口コミサービス「Lucmo」の管理画面の開発</td>
    </tr>
    <tr>
      <td>規模</td>
      <td>フロント2人・サーバサイド5〜6人でのスクラム開発</td>
    </tr>
    <tr>
      <td>役割</td>
      <td>コーディング(フロントエンド)</td>
    </tr>
    <tr>
      <td>詳細</td>
